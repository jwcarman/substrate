...
@ConditionalOnProperty(
    prefix = "substrate.postgresql.atom",
    name = "enabled",
    havingValue = "true",
    matchIfMissing = true)
public class PostgresAtomAutoConfiguration {
  ...
  public PostgresAtomSpi postgresAtom(DataSource dataSource, PostgresProperties properties) {
    ...
    return new PostgresAtomSpi(jdbcTemplate, properties.atom().prefix());
  }
}
