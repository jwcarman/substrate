...
@ConditionalOnProperty(
    prefix = "substrate.hazelcast.notifier",
    name = "enabled",
    havingValue = "true",
    matchIfMissing = true)
public class HazelcastNotifierAutoConfiguration {
  ...
  public HazelcastNotifierSpi hazelcastNotifier(
      HazelcastInstance hazelcastInstance, HazelcastProperties properties) {
    return new HazelcastNotifierSpi(hazelcastInstance, properties.notifier().topicName());
  }
}
