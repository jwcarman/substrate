...
class MongoDbJournalPropertiesTest {
  ...
  @Autowired private MongoDbJournalProperties properties;

  @Test
  void defaultsAreLoadedFromPropertiesFile() {
    assertThat(properties.prefix()).isEqualTo("substrate:journal:");
    assertThat(properties.collectionName()).isEqualTo("substrate_journal");
    assertThat(properties.ttl()).isEqualTo(Duration.ofHours(24));
  }

  @EnableConfigurationProperties(MongoDbJournalProperties.class)
  @PropertySource("classpath:substrate-journal-mongodb-defaults.properties")
  static class Config {}
}
