...
class RedisMailboxAutoConfigurationTest {
    ...
    new ApplicationContextRunner()
        .withConfiguration(
            AutoConfigurations.of(
                RedisMailboxAutoConfiguration.class, SubstrateAutoConfiguration.class))
  ...
  @Test
  void redisMailboxSuppressesInMemoryFallback() {
    new ApplicationContextRunner()
        .withConfiguration(
            AutoConfigurations.of(
                RedisMailboxAutoConfiguration.class, SubstrateAutoConfiguration.class))
