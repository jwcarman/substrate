...
public class NatsMailboxAutoConfiguration {
  ...
  public NatsMailboxSpi natsMailbox(Connection connection, NatsProperties properties) {
    NatsProperties.MailboxProperties mailbox = properties.mailbox();
    return new NatsMailboxSpi(
        connection, mailbox.prefix(), mailbox.bucketName(), mailbox.defaultTtl());
  }
}
