...
@PropertySource("classpath:substrate-notifier-nats-defaults.properties")
public class NatsNotifierAutoConfiguration {

  @Bean
  public NatsNotifier natsNotifier(Connection connection, NatsNotifierProperties properties) {
    return new NatsNotifier(connection, properties.subjectPrefix());
  }
}
