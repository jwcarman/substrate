...
@SpringBootTest(classes = RedisNotifierPropertiesTest.Config.class)
class RedisNotifierPropertiesTest {

  @Autowired private RedisNotifierProperties properties;

  @Test
  void defaultsAreLoadedFromPropertiesFile() {
    assertThat(properties.channelPrefix()).isEqualTo("substrate:notify:");
  }
