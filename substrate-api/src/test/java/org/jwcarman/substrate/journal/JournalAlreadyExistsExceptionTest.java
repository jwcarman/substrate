...
class JournalAlreadyExistsExceptionTest {

  @Test
  void messageContainsKey() {
    JournalAlreadyExistsException ex = new JournalAlreadyExistsException("my-key");
  ...
  void isThrowable() {
    assertThatThrownBy(
            () -> {
              throw new JournalAlreadyExistsException("my-key");
            })
